...
\newcommand{\figuraRegular}[2]{%
    \begin{center}
        \begin{tikzpicture}
            ...
            % Desenhar o apótema
            \draw[dashed] (0,0) -- (v1) node[midway, above] {a};

            % Posicionar a expressão matemática
            % \node[anchor=west] at (3,0) {a = $360/#1$};
            \node[anchor=west, text width=5cm] at (2,0) {%
                \pgfmathsetmacro{\alfa}{360/(2*#1)}
                \pgfmathsetmacro{\alfaB}{tan(#1*180/3.14)}
                \pgfmathsetmacro{\Atotal}{#1*2*\alfaB/2}
                \pgfmathsetmacro{\perimetro}{#1*2}
                \pgfmathsetmacro{\final}{\Atotal/\perimetro}


                \begin{align*}
                    \alpha           & = \frac{360}{2\times #1} \rightarrow \alpha = \alfa \\
                    tg(\alpha)       & = \frac{h}{L/2} \rightarrow h=\alfaB                \\
                    A_T              & = \frac{#1\times L\times h}{2} = \Atotal            \\
                    P_T              & = #1\times L = \perimetro                           \\
                    \pi_{aproximado} & = A_T/P_T = \final
                \end{align*}
            };
        \end{tikzpicture}
    \end{center}
...
\slidefiguraRegular{2}{3}
\slidefiguraRegular{2}{4}
\slidefiguraRegular{2}{5}
\slidefiguraRegular{2}{6}
\slidefiguraRegular{2}{7}
\slidefiguraRegular{2}{8}
\slidefiguraRegular{2}{9}
\slidefiguraRegular{2}{10}
\slidefiguraRegular{2}{11}
\slidefiguraRegular{2}{12}
\slidefiguraRegular{2}{40}
