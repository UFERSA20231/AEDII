...
\begin{frame}[t]
    ...
    \begin{center}
      \begin{tikzpicture}[x=50]
        % Eixo x
        \draw<1->[->, line width=1] (0,0) -- (5,0) node[right] {$x$};
        \draw<1->[->, line width=1] (0,0) -- (0,5) node[above] {$y$};
        \draw<2->[smooth, blue, line width=0.5] plot coordinates {(0,0) (1,1) (2,3) (3,2.5) (4,4) (5,5)};
        \draw<3->[smooth, blue, line width=0.5] plot coordinates {(0,0) (1,2) (2,2) (3,2) (4,3) (5,3)};
        \draw<4->[smooth, blue, line width=0.5] plot coordinates {(0,0) (1,1) (2,3) (3,2) (4,2) (5,2)};
        \draw<5->[-, line width=1, dashed] (3,5) -- (3,0) node[below] {$x=3$};
      \end{tikzpicture}
    \end{center}
  \end{frame}
