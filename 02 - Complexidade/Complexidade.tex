...
\begin{frame}[t]
    ...
    \begin{center}
      \begin{tikzpicture}[x=50]
        ...
        \draw[->, line width=1] (0,0) -- (5,0) node[right] {$n$};
        \draw[->, line width=1] (0,0) -- (0,3) node[above] {$T(n)$};
        \draw[smooth, black!80, line width=0.5] plot coordinates {(0,0) (2,2) (4,0.5) (5, 0.5)} node[above] {$c_2\times g(n)$};
        \draw[smooth, black!40, line width=0.5] plot coordinates {(0,0) (2,2) (4,0.5) (5, 0.5)} node[above] {$c_2\times g(n)$};
        \draw[smooth, blue!80, line width=0.5] plot coordinates  {(0,1) (1,0.5) (3,1.5) (5, 1.5)} node[above] {$f(n)$};
        \draw[smooth, black!80, line width=0.5] plot coordinates {(0,2) (1,1) (4,2) (5, 3)} node[above] {$c_1\times g(n)$};
        \draw[smooth, black!40, line width=0.5] plot coordinates {(0,2) (1,1) (4,2) (5, 3)} node[above] {$c_1\times g(n)$};
        \draw[smooth, blue!80, line width=1] plot coordinates  {(0,1) (1,0.5) (3,1.5) (5, 1.5)} node[above] {$f(n)$};
        \draw[thin, dashed] (2.9, 0) node[below] {$x=2.9$} -- (2.9, 3);
      \end{tikzpicture}
    \end{center}
  \end{frame}
